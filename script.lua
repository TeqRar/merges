...
title.Text = "Merge Simulator Gui"
...
Infinite.Text = "Teleport Boost"
Infinite.TextColor3 = Color3.fromRGB(255, 255, 255)
Infinite.TextSize = 20.000


local function UMTQ_fake_script() -- Auto Merge .LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
       ...
       while true do
            if click ~= 2 then
               ...
               local Char = workspace.Plots:FindFirstChild(Player.Name)
               for _,v in pairs(Char.Blocks:GetChildren()) do
                  v.CanCollide = false
                  v.CFrame = workspace:FindFirstChild(Player.Name).HumanoidRootPart.CFrame*CFrame.new(0,0,-5)
                  wait(.1)
               end
               for _,v in pairs(Char.Blocks:GetChildren()) do
                  v.CanCollide = true
...
local function EKBNYI_fake_script() --Teleprot Boost.LocalScript 
	...
	script.Parent.MouseButton1Down:Connect(function()
       ...
       script.Parent.TextColor3 = Color3.fromRGB(255,255,255)
	   local Player = game.Players.LocalPlayer
       workspace:FindFirstChild(Player.Name).HumanoidRootPart.CFrame = CFrame.new(267.1687316894531, 84.27617645263672, 0.1802062690258026)
    end)
end
